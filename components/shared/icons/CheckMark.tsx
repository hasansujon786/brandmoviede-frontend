...
export const CheckMarkDoubleIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M7.069 17.457c-.316.265-.59.397-.874.394-.657-.007-1.203-.678-2.297-2.02l-1.461-1.795c-.602-.74-.676-1.84-.18-2.67.569-.95 1.657-1.215 2.506-.74m5.776-2.424a50 50 0 0 1 2.466-2.425 1.71 1.71 0 0 1 1.468-.444"
      stroke="currentColor"
      strokeWidth={1.5}
      strokeLinecap="round"
    />
    <path
      d="M13.61 15.739c2.18-2.528 4.286-4.242 6.93-6.67.792-.727.914-2.001.293-2.904-.66-.96-1.914-1.15-2.762-.388-2.423 2.176-4.307 4.272-6.094 6.512-.094.117-.141.176-.19.209a.355.355 0 0 1-.402.002c-.049-.032-.096-.09-.19-.205l-.952-1.168c-.87-1.067-2.428-.949-3.154.238-.508.83-.432 1.931.183 2.67l1.493 1.796c1.118 1.342 1.676 2.013 2.347 2.02.67.007 1.28-.7 2.498-2.112Z"
      stroke="currentColor"
      strokeWidth={1.5}
    />
  </svg>
