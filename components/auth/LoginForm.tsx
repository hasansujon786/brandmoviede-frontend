  ...
  return (
    <div
      className={cn("flex items-center justify-center", {
        "min-h-screen p-4": !onlyCard,
      })}
    >
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className={cn("mb-8 flex justify-center", { hidden: onlyCard })}>
          <Image
        ...
        <Card
          className={cn("border-0 shadow-lg", {
            "shadow-none": onlyCard,
          })}
        >
          ...
          <CardContent className={cn({ "px-0": onlyCard })}>
            <form
              onSubmit={(e) => {
                e.preventDefault();
                form.handleSubmit();
