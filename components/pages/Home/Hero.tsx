...
} from "@/components/shared/Dobi/Dobi";
import SectionHeading from "@/components/shared/SectionHeading/SectionHeading";
import { Button } from "@/components/ui/button";
import Link from "next/link";

const dobiConfig: DobisConfig = [
...
export default function Hero() {
  ...
  return (
    ...
    >
      <Dobis items={dobiConfig} />
      <section className="hero slide-scope pt-6 pb-20 sm:pb-24 md:pt-48 md:pb-78">
...
const HeadingFooter = () => {
  return (
    <div className="mt-16 flex flex-col justify-center gap-4 sm:flex-row sm:items-center">
      <Button className="min-w-40" variant="primary" asChild>
        <Link href="/bundles">Buy Coins</Link>
      </Button>
